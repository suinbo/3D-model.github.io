...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:Bi,depthTest:!1,depthWrite:!1})}function bp(){return new ji({name:"EquirectangularToCubeUV",uniforms:{envMap:{value:null}},vertexShader:od(),fragmentShader:`
		...
		`,blending:Bi,depthTest:!1,depthWrite:!1})}function Dp(){return new ji({name:"CubemapToCubeUV",uniforms:{envMap:{value:null},flipEnvMap:{value:-1}},vertexShader:od(),fragmentShader:`
